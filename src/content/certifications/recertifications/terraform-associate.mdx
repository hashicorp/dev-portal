...
#### Option 1: Pass the Terraform Infrastructure Engineer Professional exam
...
#### Option 3: Pass the 004 version of the Terraform Associate exam starting 6 months before expiration

- Extend your existing credentials' expiration date
...
#### Option 2: Pass the Terraform Authoring and Operations Advanced exam
...
- [Review the content differences](https://developer.hashicorp.com/terraform/tutorials/certification-004/associate-study-004#content-differences-between-the-003-and-004-exams) between the 003 and 004 version of the exam as part of your recertification preparation.
