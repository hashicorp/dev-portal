To renew your certification, you will need to take and pass either the AWS or Azure version of the Terraform Authoring & Operations Advanced exam. You do not need to pass the same exam version (AWS or Azure) to renew.
