...
This performance-based exam contains labs that must be completed in a virtual environment along with a shorter multiple-choice section. The lab scenarios present you with a scenario in which you solve problems using Terraform. You will have access to Terraform documentation, cloud provider documentation, and limited Registry access.
