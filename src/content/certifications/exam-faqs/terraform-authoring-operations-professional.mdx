...
This exam assesses both advanced configuration authoring and a deep understanding of Terraform workflows. Earning this credential reflects that the practitioner has professional-level expertise in both domains. We strongly recommend that you pass the associate-level Terraform exam before taking the professional-level exam. 

Prerequisites:

- Experience using Terraform in a production environment
...
|                     |                               |
| ------------------- | ----------------------------- |
| **Assessment Type** | [Lab-based](/terraform/tutorials/pro-cert/pro-orientation) and multiple choice |
