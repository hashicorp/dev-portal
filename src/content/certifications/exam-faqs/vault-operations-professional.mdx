...
To take this exam, you should be prepared to demonstrate your ability to deploy, configure, manage, and monitor HashiCorp Vault.  
...
This performance-based exam contains lab scenarios and a short multiple-choice section, all inside a virtual environment. You can use the Vault UI and API and you will have access to the Vault and Vault API documentation during the exam. 
