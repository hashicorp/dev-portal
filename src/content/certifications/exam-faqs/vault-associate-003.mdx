...
The new Vault Associate 003 exam accounts for how Vault has grown since we released the (002) exam version. 
...
**8a:** Differentiate between self-managed and HashiCorp-managed Vault clusters

**9b:** Describe the Vault Secrets Operator

Both exams are valid ways to verify your Vault knowledge at the associate level. 
- If you have prepared based on the (002) content, schedule your exam before January 15. 
- If you are just beginning your Vault Associate certification journey, consider preparing for the Vault Associate 003 exam. You can schedule this exam starting on November 27.
