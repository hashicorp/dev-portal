...
**If you hold an *expired* Vault Associate certification there are two ways to recertify:** You can take the same Vault Associate exam again at any time. When you pass the exam, you will receive a new, second set of credentials with a new expiration date. 
