...
**If you hold an *expired* Vault Associate certification there are two ways to recertify:**
1. You can take the same Vault Associate exam again at any time. When you pass the exam, you will receive a new, second set of credentials with a new expiration date. 
2. You can take the Vault Professional level exam at any time. When you pass the exam, you will receive a new set of credentials for the Vault Professional certification. The expiration date on your expired Vault Associate credentials will not be extended.
