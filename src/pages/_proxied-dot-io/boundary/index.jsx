...
import BrandedCta from 'components/_proxied-dot-io/boundary/branded-cta'
import HomepageHero from 'components/_proxied-dot-io/boundary/homepage-hero'
import HowItWorks from 'components/_proxied-dot-io/boundary/how-it-works'
import HowBoundaryWorks from 'components/_proxied-dot-io/boundary/how-boundary-works'
import WhyBoundary from 'components/_proxied-dot-io/boundary/why-boundary'
    ...
    <div className="p-home">
        ...
        features={[
          {
            ...
            logos: [
              {
                alt: 'GitHub',
                url: require('./home/img/logos/github-black.svg?url'),
              },
              {
                alt: 'AWS',
                url: require('./home/img/logos/aws-color.svg?url'),
              },
              {
                alt: 'Microsoft Azure',
                url: require('./home/img/logos/azure-color.svg?url'),
              },
              {
                alt: 'Google Cloud Platform',
                url: require('./home/img/logos/gcp-color.svg?url'),
              },
              {
                alt: 'Okta',
                url: require('./home/img/logos/okta-color.svg?url'),
              },
              {
                alt: 'Ping',
                url: require('./home/img/logos/ping-color.svg?url'),
              },
              {
                alt: 'More integrations',
                url: require('./home/img/logos/custom.svg?url'),
              },
            ],
          },
          {
            ...
            logos: [
              {
                alt: 'Consul',
                url: require('./home/img/logos/consul-color.svg?url'),
              },
              {
                alt: 'AWS',
                url: require('./home/img/logos/aws-color.svg?url'),
              ...
              {
                alt: 'Terraform',
                url: require('./home/img/logos/terraform-color.svg?url'),
              },
              {
                alt: 'Google Cloud Platform',
                url: require('./home/img/logos/gcp-color.svg?url'),
              ...
              {
                alt: 'Kubernetes',
                url: require('./home/img/logos/kubernetes-color.svg?url'),
              },
              {
                alt: 'More integrations',
                url: require('./home/img/logos/custom.svg?url'),
          ...
          },
          {
            ...
            logos: [
              {
                alt: 'Postgresql',
                url: require('./home/img/logos/postgresql.png?url'),
                width: 36,
              },
              {
                alt: 'SSH',
                url: require('./home/img/logos/ssh.svg?url'),
                width: 42,
              },
              {
                alt: 'Mongo DB',
                url: require('./home/img/logos/mongo-db.svg?url'),
              },
              {
                alt: 'AWS',
                url: require('./home/img/logos/aws-color.svg?url'),
              ...
              {
                alt: 'Unknown',
                url: require('./home/img/logos/unknown.svg?url'),
              },
              {
                alt: 'MySQL',
                url: require('./home/img/logos/my-sql-color.svg?url'),
              },
              {
                alt: 'More integrations',
                url: require('./home/img/logos/custom.svg?url'),
      ...
      <section className="why-boundary">
        <WhyBoundary
          ...
          items={[
            {
              icon: require('./home/img/icons/code-white.svg?url'),
            ...
            {
              icon: require('./home/img/icons/layers-white.svg?url'),
            ...
            {
              icon: require('./home/img/icons/refresh-white.svg?url'),
              heading:
      ...
      <section className="how-boundary-works">
        <HowBoundaryWorks
          ...
          img={{
            src: require('./home/img/how-boundary-works.svg'),
            alt: 'How it works',
          }}
        />
      </section>
          ...
          features={[
            {
              ...
              icon: require('./home/img/icons/user.svg?url'),
              link: {
                type: 'inbound',
                text: 'Learn more',
                url:
            ...
            },
            {
              ...
              icon: require('./home/img/icons/activity.svg?url'),
              link: {
                type: 'inbound',
                text: 'Learn more',
                url:
            ...
            },
            {
              ...
              icon: require('./home/img/icons/star.svg?url'),
              link: {
                type: 'inbound',
                text: 'Learn more',
            ...
            },
            {
              ...
              icon: require('./home/img/icons/lock.svg?url'),
              link: {
                type: 'inbound',
                text: 'Learn more',
                url:
            ...
            },
            {
              ...
              icon: require('./home/img/icons/layers.svg?url'),
            },
            {
            ...
            items={[
              {
                ...
                image: {
                  url: require('./home/img/red-usecase-accessmgmt.png?url'),
                },
                link: {
                  title: 'Learn more',
              ...
              },
              {
                ...
                image: {
                  url: require('./home/img/red-usecase-compliancewithoutoverhead.png?url'),
                },
                link: {
                  title: 'Learn more',
                  url:
              ...
              },
              {
                ...
                image: {
                  url: require('./home/img/red-usecase-integratedsystem.png?url'),
                },
                link: {
                  title: 'Learn more',
                  url:
