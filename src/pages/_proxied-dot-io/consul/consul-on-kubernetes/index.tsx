...
import BlockList from 'components/_proxied-dot-io/consul/block-list'
import SideBySide from 'components/_proxied-dot-io/consul/side-by-side'
import CardList from 'components/_proxied-dot-io/consul/card-list'
import DocsList from 'components/_proxied-dot-io/consul/docs-list'
import s from './style.module.css'

function ConsulOnKubernetesPage() {
