...
import HomepageHero from 'components/_proxied-dot-io/vault/homepage-hero'
import SectionHeader from '@hashicorp/react-section-header'
import UseCases from '@hashicorp/react-use-cases'
import TextSplits from '@hashicorp/react-text-splits'
import Button from '@hashicorp/react-button'
import BeforeAfterDiagram from 'components/_proxied-dot-io/vault/before-after-diagram'
import HcpCalloutSection from 'components/_proxied-dot-io/vault/hcp-callout-section'
...
import processBeforeAfterDiagramProps from 'components/_proxied-dot-io/vault/before-after-diagram/server'
    ...
    <main id="page-home">
      <div className="g-section-block page-wrap">
        ...
        <section className="g-grid-container before-after">
          <BeforeAfterDiagram
            ...
            beforeImage={{
              ...
              format: 'png',
              url: require('./home/img/vault_static_isometric@2x.png'),
            }}
            afterImage={{
              alt: 'Dynamic VM and database graphic',
              format: 'png',
              url: require('./home/img/vault_dynamic_isometric@2x.png'),
            }}
          />
        </section>
              ...
              items={[
                {
                  ...
                  image: {
                    alt: 'Key icon',
                    format: 'png',
                    url: require('./home/img/use-cases/secrets-management.svg?url'),
                  },
                  link: {
                    external: false,
                    title: 'Learn more',
                ...
                },
                {
                  ...
                  image: {
                    alt: 'Lock icon',
                    format: 'png',
                    url: require('./home/img/use-cases/data_encryption.svg?url'),
                  },
                  link: {
                    external: false,
                    title: 'Learn more',
                ...
                },
                {
                  ...
                  image: {
                    ...
                    format: 'png',
                    url: require('./home/img/use-cases/identity-based-access.svg?url'),
                  },
                  link: {
                    external: false,
                    title: 'Learn more',
        ...
        <HcpCalloutSection
          ...
          image={require('./home/img/hcp_vault.svg?url')}
          links={[
            {
              text: 'Learn More',
              url:
