...
import UseCaseCtaSection from 'components/_proxied-dot-io/vault/use-case-cta-section'
...
function SecretsManagmentUseCase({ content }) {
  return (
...
SecretsManagmentUseCase.layout = VaultIoLayout
export default SecretsManagmentUseCase
