	...
	return (
		<>
			...
			<IoUsecaseHero
				...
				pattern={require('/public/packer-public/img/usecase-hero-pattern.svg')}
			/>
			...
			<div className={s.callToAction}>
				<IoUsecaseCallToAction
					...
					pattern={require('/public/packer-public/img/usecase-callout-pattern.svg')}
				/>
			</div>
...
export async function getStaticPaths() {
	...
	return {
		paths: allPackerUseCases.map((page) => {
			return {
				params: {
					slug: page.slug,
				},
...
export async function getStaticProps({ params }) {
	...
	const page = allPackerUseCases.find((page) => page.slug === slug)
