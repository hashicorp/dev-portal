...
import AnimatedTerminal from 'components/_proxied-dot-io/packer/animated-terminal'
import BrandedCta from 'components/_proxied-dot-io/packer/branded-cta'
import HomepageHero from 'components/_proxied-dot-io/packer/homepage-hero'
import IntegrationsTextSplit from 'components/_proxied-dot-io/packer/integrations-text-split'
import SectionBreakCta from 'components/_proxied-dot-io/packer/section-break-cta'
		...
		<div id="p-home" className={s.home}>
					...
					features={[
						{
							...
							icon: '/packer/img/product-features-list/deployment.svg',
						},
						{
							...
							icon: '/packer/img/product-features-list/portability.svg',
						},
						{
							...
							icon: '/packer/img/product-features-list/stability.svg',
						},
						{
							...
							icon: '/packer/img/product-features-list/prod-parity.svg',
						},
						{
							...
							icon: '/packer/img/product-features-list/continuous-delivery.svg',
						},
						{
							...
							icon: '/packer/img/product-features-list/demo-creation.svg',
						},
					]}
				/>
			</section>
			...
			<section>
				<IntegrationsTextSplit
					...
					image={{
						url: '/packer/img/integrations-text-split/integrations.png',
