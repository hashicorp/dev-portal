    ...
    >
          ...
          links: [
            {
              ...
              url: 'https://www.hashicorp.com/resources/move-your-vmware-workloads-nomad',
              type: 'outbound',
            },
          ],
        }}
          ...
          links: [
            {
              ...
              url: 'https://www.hashicorp.com/resources/backend-batch-processing-nomad',
              type: 'outbound',
            },
          ],
        }}
      ...
      <FeaturedSlider
        ...
        features={[
          {
            logo: {
              url: 'https://www.datocms-assets.com/2885/1582149907-graymetalogo.svg',
              alt: 'GrayMeta',
            },
            image: {
...
NonContainerizedApplicationOrchestrationPage.layout = NomadIoLayout
