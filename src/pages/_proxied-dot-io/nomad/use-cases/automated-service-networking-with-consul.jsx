      ...
      <TextSplitWithImage
        textSplit={{
          ...
          links: [
            {
              text: 'Read More',
              url: 'https://learn.hashicorp.com/tutorials/nomad/clustering#use-consul-to-automatically-cluster-nodes',
              type: 'outbound',
            },
          ],
        }}
        ...
        features={[
          {
            ...
            link: {
              text: 'Learn More',
              url: 'https://www.hashicorp.com/resources/deluxe-hashistack-video-production',
              type: 'outbound',
            },
          },
          {
            ...
            link: {
              text: 'Learn More',
              url: 'https://www.hashicorp.com/resources/seatgeek-and-the-hashistack-a-tooling-and-automation-love-story',
              type: 'outbound',
            },
          },
        ]}
...
AutomatedServiceNetworkingWithConsulPage.layout = NomadIoLayout
