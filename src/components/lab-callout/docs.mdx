...
<!--
Note: component is actually called InteractiveLabCallout.
But the name mismatch makes Swingset angry.
I think we'd need to rename the component folder in order
to make Swingset happy.
-->
