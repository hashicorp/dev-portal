...
import ConfigureYourApp from './components/sections/how-it-works/configure-your-app'
import BuildAndDeploy from './components/sections/how-it-works/build-and-deploy'
import MonitorAndManage from './components/sections/how-it-works/monitor-and-manage'
import SectionMonitorAppHealth from './components/sections/monitor-app-health'
import SectionExtendPlugins from './components/sections/extend-plugins'
import SectionCallToAction from './components/sections/call-to-action'
import s from './style.module.css'

function WaypointSecretMarketingHomepage(): JSX.Element {
  return (
    <div className={s.homePage}>
      ...
      <SectionIntro
        columnLeft={{
          ...
          features: [
            {
              icon: require('views/waypoint/_secret-io-homepage/components/icons/layers.svg?include'),
            ...
            {
              icon: require('views/waypoint/_secret-io-homepage/components/icons/link.svg?include'),
        ...
        columnRight={{
          ...
          features: [
            {
              icon: require('views/waypoint/_secret-io-homepage/components/icons/maximize.svg?include'),
            ...
            {
              icon: require('views/waypoint/_secret-io-homepage/components/icons/sidebar.svg?include'),
      ...
      <SectionHowItWorks>
        <ConfigureYourApp
          ...
          features={[
            {
              icon: require('views/waypoint/_secret-io-homepage/components/icons/edit-pencil.svg?include'),
              heading: 'Writing waypoint.hcl files',
              description:
                'Your waypoint.hcl file defines how Waypoint builds, deploys, and releases a project.',
            },
            {
              icon: require('views/waypoint/_secret-io-homepage/components/icons/layout.svg?include'),
    ...
    <span class="token keyword">set</span> {
      ...
      <span class="token keyword">value</span> = artfact.name
        ...
        <BuildAndDeploy
          ...
          features={[
            {
              icon: require('views/waypoint/_secret-io-homepage/components/icons/file-plus.svg?include'),
        ...
        <MonitorAndManage
          ...
          features={[
            {
              icon: require('views/waypoint/_secret-io-homepage/components/icons/sliders.svg?include'),
      ...
      <SectionExtendPlugins
        ...
        features={[
          {
            icon: require('views/waypoint/_secret-io-homepage/components/icons/box.svg?include'),
          ...
          {
            icon: require('views/waypoint/_secret-io-homepage/components/icons/code-union.svg?include'),
      ...
      <SectionCallToAction
        features={[
          {
            media: {
              src: '/img/waypoint/prebuilt-binaries.svg',
              alt: '',
              width: 189,
              height: 44,
            },
          ...
          {
            media: {
              src: '/img/waypoint/deploys-kubernetes-helm.svg',
              alt: '',
              width: 121,
              height: 44,
            },
          ...
          {
            media: {
              src: '/img/waypoint/first-party-aws-docker.svg',
              alt: '',
              width: 122,
              height: 42,
            },
          ...
          {
            media: {
              src: '/img/waypoint/extensible-plugins.svg',
              alt: '',
              width: 65,
              height: 42,
            },
