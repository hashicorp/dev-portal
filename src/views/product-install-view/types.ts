...
export interface RawProductInstallViewContent {
...
export interface ProductInstallViewProps {
 ...
 */
export interface ProductInstallViewContentProps {
	isEnterpriseMode: ProductInstallViewProps['isEnterpriseMode']
	merchandisingSlot?: ProductInstallViewProps['merchandisingSlot']
	pageContent: ProductInstallViewProps['pageContent']
	releases: ProductInstallViewProps['releases']
	packageManagers: ProductInstallViewProps['packageManagers']
 ...
 */
export interface ProductInstallViewStaticProps extends GeneratedProps {
	pageContent: ProductInstallViewProps['pageContent']
}
